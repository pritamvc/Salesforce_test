...
export default class LeadEmploymentDetails extends LightningElement {
   ...
   // Nature of Professional Picklist from Employement Details
    ...
    handleSaveEmployment(event) {
        ...
        console.log('record.objEmployment.NatureofBusiness__c 782 111', record.objEmployment.NatureofBusiness__c);
        if (this.listOfEmploymentTable.length > 0) {
            console.log('record.objEmployment.NatureofBusiness__c 784 222', record.objEmployment.NatureofBusiness__c);
            for (var i = 0; i < this.listOfEmploymentTable.length; i++) {
