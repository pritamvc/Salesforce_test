...
// import class
import KarzaPennyDrop from '@salesforce/apex/DocumentVerification.BankVerification'

export default class fincialLead extends LightningElement {
    ...
    //handleBlurAccount -- call panny drop
    handleBlurAccount(event){
        var foundelement = this.listOfFinancialTable.find(ele => ele.Id == event.target.dataset.id);
        var Account_Number= foundelement.Account_Number__c;
        var IFSC_Code = foundelement.IFSC_Code__c;

        console.log('leadid'+this.leadRecordId);
        // console.log('AccId :'+ this.Account__c);
        console.log('AccId :'+ foundelement.Account__c);
        console.log('IFSc'+IFSC_Code);
        console.log(' Account_Number= '+ Account_Number);
        console.log('Call method')
        //call method to call panny drop api 
        KarzaPennyDrop({
            leadId: this.leadRecordId,
            accId : foundelement.Account__c,
            consent:'Y',
            ifsc:IFSC_Code,
        ...
        .then(async (result) => {
            ...
            console.log('This is responce body '+'*'*10)
            console.log('responseObj ==>', JSON.stringify(JSON.parse(responseObj), null, 2));
            var bankResponse=responseObj.bankResponse
