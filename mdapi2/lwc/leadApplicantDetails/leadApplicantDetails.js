...
import isPassportUploaded from '@salesforce/apex/LeadApplicantDetails.isPassportUploaded';// Added by Rohit 
import getCoApplicantAccoutId from '@salesforce/apex/LeadApplicantDetails.getCoApplicant';// Added by Rohit 
...
import savedOCRDoc from '@salesforce/apex/LeadApplicantDetails.savedOCRDoc';// Added by Rohit 
...
export default class CommunityFormARS extends LightningElement {
    ...
    handleaddress(event){
        if (event.target.name == "Current Address Landmark") {
            ...
            if (this.AppliCurrentLandmark.length > 50){
                this.showToast("Error!!", "Landmark for Current Address cannot be greater than 50 characters", "Error")
            }else{
                this.AppliPermanentLandmark =  event.target.value;
            }

        }else if (event.target.name == "Permanent Address Landmark") {
            this.AppliPermanentLandmark = event.target.value;

            if (this.AppliPermanentLandmark.length > 50){
    ...
    handleSaveApplicant() {
        ...
        else if (this.AppliPermanentLandmark.length > 50){
            this.showToast("Error!!", "Landmark for Permanent Address cannot be greater than 50 characters", "Error")
        }
    ...
    handleNextApplicant() {
        ...
        if (this.AppliCurrentLandmark.length > 50){
            ...
            this.showToast("Error!!", "Landmark for Permanent Address cannot be greater than 50 characters", "Error")
        }else if (this.passportNumber == undefined && this.getCountryOfStudyLead != undefined && this.getCountryOfStudyLead != 'INDIA') {
