    ...
    getObjectData4({ error, data }) {
        ...
        if (data) {
            ...
            console.log('Inside recordTypeId3');
                ...
                this.TypeOfAppliFromCoAppliLabel = data.fields[this.TypeOfAppliFromCoAppliLabel].label;   
 ...
 handleVerifyMob(){
    ...
    initData() {
       // debugger;
        ...
        // this.createRowEducational(listOfEducationalTable);
        // this.listOfEducationalTable = listOfEducationalTable;

      //  let listOfEducationalTable = [];
       // this.addRow(listOfEducationalTable);
       // this.listOfEducationalTable = listOfEducationalTable;
        console.log('@@@ ' +this.listOfEducationalTable);
        // this.addRow();
    }
    ...
    //createRowEducational(listOfEducationalTable) {
    //     let EducationalData = {};
    //     if(listOfEducationalTable.length > 0) {
    //         EducationalData.index = listOfEducationalTable[listOfEducationalTable.length - 1].index + 1;
    //         console.log(" EducationalData.index", EducationalData.index);
    //    this.EduIndex = EducationalData.index
    //    console.log("this.EduIndex",this.EduIndex)
    // } else {
    //     EducationalData.index = 1;
    // }
    //     EducationalData.Education_Qualification__c = null;
    //     EducationalData.Year_Completed__c = null;
    //     EducationalData.Percentage_Marks_CGPA__c = null;       
    //     EducationalData.School_College_University__c   = null;        
    //     listOfEducationalTable.push(EducationalData);
    ...
    // addNewRowEducational() {
    //     console.log("clickedddddd");
    //     this.createRowEducational(this.listOfEducationalTable);
    // }
    @track deleteEmpIds = '';
    removeTheRowEducational(event) {
        ...
        // let sum = 0;
        // for (let i = 0; i < this.listOfEducationalTable.length; i++) {
        //   sum += this.listOfEducationalTable[i].index;
        // }
        // if(sum == 1){
        ...
        //     let listOfEducationalTable = [];
        //     for(let i = 0; i < this.listOfEducationalTable.length; i++) {
        //         let tempRecord = Object.assign({}, this.listOfEducationalTable[i]); //cloning object
        //         if(tempRecord.index !== toBeDeletedRowIndex) {
        //             listOfEducationalTable.push(tempRecord);
        //         }
        //     }
        //     for(let i = 0; i < listOfEducationalTable.length; i++) {
        //         listOfEducationalTable[i].index = i + 1;
        //     }
        //     this.listOfEducationalTable = listOfEducationalTable;
        // }
    }
    ...
    handlechange(event) {
        ...
        // for(let i = 0; i < this.listOfCoappliAccTable.length; i++) {
        //     if(this.listOfCoappliAccTable[i].index === parseInt(index)) {
        //         this.listOfCoappliAccTable[i][fieldName] = value;
        //         console.log("event.target.value====  " + this.listOfCoappliAccTable[i][fieldName]);        
        //     }
        // }
        // for(let i = 0; i < this.listOfEducationalTable.length; i++) {
        //     if(this.listOfEducationalTable[i].index === parseInt(index)) {
        //         this.listOfEducationalTable[i][fieldName] = value;
        //         console.log("event.target.value====  " + this.listOfEducationalTable[i][fieldName]);        
        //     }
        // }
        if (event.target.name == "salutation" && event.target.value != "") {
        ...
        if (event.target.name == "LastName1" && event.target.value != "") {
        ...
        if (event.target.name == "MotherFirstName" && event.target.value != "") {
        ...
        if (event.target.name == "FatherFirstName" && event.target.value != "") {
        ...
        if (event.target.name == "SpouseFirstName" && event.target.value != "") {
    ...
    //     }
        ...
        // console.log('this.listOfEducationalTable[index][fieldName]' + JSON.stringify(this.listOfEducationalTable[index]));
        // this.listOfEducationalTable[index][fieldName] = value;
        // console.log('this.listOfEducationalTable[index][fieldName]sssss' + this.listOfEducationalTable[index][fieldName]);
    //}
   @track YearCompleted;
   ...
   @track SchoolCollegeUniversity;
    ...
    handleCoappliAcc(event) {  
        ...
        // console.log('value' + value);
        // console.log('fieldName' + fieldName);
        // console.log('this.listOfApplicants[index][fieldName]' + JSON.stringify(this.listOfApplicants[index - 1]));
        // this.listOfApplicants[index - 1][fieldName] = value;
        // console.log('this.listOfApplicants[index][fieldName]' + this.listOfApplicants[index - 1][fieldName]);
        console.log('this.listOfApplicants valuessss===>' + JSON.stringify(this.listOfApplicants));
        var foundelementCoAppli = this.listOfApplicants.find(ele => ele.Id == event.target.dataset.id);
        console.log('foundelementCoAppli' + JSON.stringify(foundelementCoAppli));
        if(event.target.name === 'coAppliRelationProof'){   
    ...
    handleCoAppliCurrentPincode(event){
        ...
        getPincodeRecord({ pincode: this.AreaPinCode3 }) //this parameter is passed to Class-CommunityLeadFormController.getPincodeRecord
            .then(result => {
                ...
                console.log('pincodeResult Coappli Current=======> ' + JSON.stringify(this.AreaPinCodeResult3));
                this.Pin_Code__c = this.AreaPinCodeResult3.Id;
                console.log('Pin_Code__c Coappli Current=======> ' + this.Pin_Code__c);
                this.coAppliCurrentCity = this.AreaPinCodeResult3.City_Name__c;
                console.log('this.coAppliCurrentCity Coappli Current=======> ' + this.coAppliCurrentCity);                
                this.State__c = this.AreaPinCodeResult3.State__c;
                this.Country__c = this.AreaPinCodeResult3.Country__c;
                this.District__c = this.AreaPinCodeResult3.Area_Name_Taluka__c;
                this.Taluka__c = this.AreaPinCodeResult3.Area_Name_Taluka__c;
            })
            .catch(error => {
                this.errors = error;
  ...
  //  @track listOfCoappliAcc;
    ...
    wiredWrapperClassCommFormList({ error, data }) {
        ...
        if (data) {
            ...
            console.log('this.wrapperForCommLeadForm data' + this.wrapperForCommLeadForm);
         ...
         //   this.listOfCoappliAccTable = this.wrapperForCommLeadForm.AccCoAppliRecords;
            ...
            //console.log('First Name======>' +  this.listOfCoappliAccTable.Account__r.FirstName);
            //Lead Applicant
           ...
           //Check if Marital status is Marriend then show Spouse fields
            ...
            //Applicant Account Eductional Details
            // this.EducationDetailsValue = this.wrapperForCommLeadForm.AppliEduDetailsRecord.Education_Qualification__c;
            // console.log('this.EducationDetailsValue data===>' + JSON.stringify(this.wrapperForCommLeadForm.AppliEduDetailsRecord.Education_Qualification__c));
            // this.EduYearCompleted = this.wrapperForCommLeadForm.AppliEduDetailsRecord.Year_Completed__c;
            // console.log('this.EduYearCompleted data===>' + this.EduYearCompleted);
            // this.EduPercentageMarksCGPA = this.wrapperForCommLeadForm.AppliEduDetailsRecord.Percentage_Marks_CGPA__c;
            // this.EduSchoolCollegeUniversity = this.wrapperForCommLeadForm.AppliEduDetailsRecord.School_College_University__c  ;

            //Co-applicant data
            this.CoAppliFirstName = this.wrapperForCommLeadForm.AccCoAppliRecords.Account__r.FirstName;
            this.CoAppliMiddleName = this.wrapperForCommLeadForm.AccCoAppliRecords.Account__r.MiddleName;
            this.CoAppliLastName = this.wrapperForCommLeadForm.AccCoAppliRecords.Account__r.LastName;
            this.CoAppliDOB = this.wrapperForCommLeadForm.AccCoAppliRecords.Account__r.Date_of_Birth__c;
        ...
        //     this.ShowFieldsCourseInstAndCampus = true;
        //     console.log("this.ShowFieldsCourseInstAndCampus====  " + this.ShowFieldsCourseInstAndCampus);
        // } 
        // else{
        //     this.ShowFieldsCourseInstAndCampus = false;
        //     console.log("this.ShowFieldsCourseInstAndCampus====  " + this.ShowFieldsCourseInstAndCampus);
        // }  
    }
    ...
    handleSaveCoApplicant(){  
        ...
        let wrapperCommFormCoAppliRecord ={            
            coAppliSectionSave : JSON.stringify(this.listOfApplicants)    
        }
        console.log('wrapperCommFormCoAppliRecord=====>' + JSON.stringify(wrapperCommFormCoAppliRecord));            

        communityWrapperFormMethod({            
            wrapperCommFormCoAppliDetails : JSON.stringify(wrapperCommFormCoAppliRecord)                
        })
            .then(response => {
                console.log(response);
                if(response != null){
    ...
    handleSaveLead(){
       if((this.AppliPermanentCountry != 'INDIA' && this.AppliPermIsCommAddressvalue == 'Permanent Address')|| this.AppliCurrentCountry != 'INDIA' && this.AppliPermIsCommAddressvalue == 'Current Address'){
        ...
        // let AppliEduDetailsSaveRec = {
        //     Education_Qualification__c : this.EducationDetailsValue,            
        //     Year_Completed__c : this.EduYearCompleted,          
        //     Percentage_Marks_CGPA__c : this.EduPercentageMarksCGPA, 
        //     School_College_University__c : this.EduSchoolCollegeUniversity,
        //     Account__c: this.AppliAccID,           
        // }
        // console.log('AppliEduDetailsSaveRec=====>' +  JSON.stringify(AppliEduDetailsSaveRec)); 
