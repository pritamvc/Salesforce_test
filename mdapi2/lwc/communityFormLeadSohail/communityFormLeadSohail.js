...
import creatLeadRecord from '@salesforce/apex/TempControllerSohail.creatLeadRecord';
...
export default class CommunityFormARS extends LightningElement {
  ...
  handleClickFive() {
    console.log('In section 5 update ')
    this.secFive = true;
    console.log('secFive value'+this.secFive);
    this.secSix = false;
    console.log('secSix value'+this.secSix);
    this.secSeven = false;
    console.log('secFive value'+this.secSeven);
    this.secEight = false;
    console.log('secEight value'+this.secEight);
    this.secNine = false;
    console.log('secNine value'+this.secNine);
    this.secTen = false;
    console.log('secTen value'+this.secTen);
}
   handleClickSix() {
    this.secFive = false;
    this.secSix = true;
 ...
 handleVerifyMob(){
    ...
    handleCourseInstAndCampusShowHide(event){
        ...
        //     console.log("this.ShowFieldsCourseInstAndCampus====  " + this.ShowFieldsCourseInstAndCampus);
        // }          
        getUniversityNameCourse({ universityId: this.universityName }) //this parameter is passed to Class-TempControllerSohail.getInstituteRecord
        .then(result => {
    ...
    handleInstituteSelection(event) {        
        ...
        getInstituteRecord({ instituteId: this.InstituteId }) //this parameter is passed to Class-TempControllerSohail.getInstituteRecord
            .then(result => {
    ...
    handlePincodeSelection(event){
        ...
        getPincodeRecord({ pincode: this.AreaPinCode }) //this parameter is passed to Class-TempControllerSohail.getPincodeRecord
            .then(result => {
    ...
    getCoapp({ error, data }) {
        ...
        if (data) {
            ...
            console.log('this.listOfApplicants data' + this.listOfApplicants);
  ...
  //  @track listOfCoappliAcc;
    ...
    wiredWrapperClassCommFormList({ error, data }) {
        ...
        if (data) {
            ...
            //     console.log("this.listOfFinancialTable===>" + this.listOfFinancialTable); 
            //     //this.listOfEducationalTable = listOfEducationalTable;
            // }
            //this.listOfEducationalTable  = JSON.parse(JSON.stringify(this.wrapperForCommLeadForm.AppliEduDetailsRecord)); 
    ...
    handleOnSave(event){
        let valueFromFinance = event.detail;
        console.log(valueFromFinance);
        this.handleClickEight();
    }
    @track activetabValue = 'one';  
