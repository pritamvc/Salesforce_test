...
import getapplicantData from '@salesforce/apex/LeadApplicantDetails.getLeadRelatedRecord';
...
export default class DeveloperParentCommunityForm extends LightningElement {
    ...
    handleFinalSubmit() {
        ...
        validateDocuments({leadRecordId: this.recordId})
            .then((result) => {  
                if(result != 'null'){
                    var error = result;
...
*/
    ...
    gdoc5photo(event){
        ...
        for (var i in this.dmsNames) {
            if (this.dmsNames[i].applicantType== 'Guarantor' && this.dmsNames[i].documentType=="Photo") {
                this.otherincomecoapp = this.dmsNames[i].label;
            }
   ...
   @track dlfgrntrname
    ...
    handleAccordionClick(event) {
        ...
        .then(result => {
            ...
            console.log("FullDocument==", this.allDoc);
             ...
             this.coApp4Array = result.filter(item => item.includes('CoApp_4'));
    ...
    //    debugger
            ...
            if (event.detail.openSections == this.TypeOptions[i].value) {
                ...
                if (this.TypeOptions[i].index == 4 && this.TypeOptions[i].type =="Co-applicant") {
                    for (var j in this.coApp4Array) {
                        console.log("coooo" + this.coApp4Array[j]);
                        if ((this.coApp4Array[j].includes("Aadhar"))&&(this.coApp4Array[j].includes("front"))) {
                            this.doc23 = true;
                            this.doc23name = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("Aadhar")&&this.coApp4Array[j].includes("back")) {
                            this.doc24 = true;
                            this.doc24name = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("pan")) {
                            this.doc28 = true;
                            this.doc28name = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("passport")&&this.coApp4Array[j].includes("front")) {
                            this.doc25 = true;
                            this.doc25name = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("passport")&&this.coApp4Array[j].includes("back")) {
                            this.doc26 = true;
                            this.doc26name = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("voter")&&this.coApp4Array[j].includes("front")) {
                            this.doc29 = true;
                            this.doc29name = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("voter")&&this.coApp4Array[j].includes("back")) {
                            this.doc30 = true;
                            this.doc30name = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("Driving")&&this.coApp4Array[j].includes("front")) {
                            this.coDocDLfront = true;
                            this.coDocDLfrontName = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("Driving")&&this.coApp4Array[j].includes("back")) {
                            this.coDocDLback = true;
                            this.coDocDLbackName = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("Bank_statement")) {
                            this.doc31 = true;
                            this.doc31name = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("Other_income")) {
                            this.doc32 = true;
                            this.doc32name = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("Photo")) {
                            this.doc27 = true;
                            this.doc27name = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("other_doc1")) {
                            this.doc33 = true;
                            this.doc33name = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("other_doc2")) {
                            this.doc34 = true;
                            this.doc34name = this.coApp4Array[j];
                        } else if (this.coApp4Array[j].includes("other_doc3")) {
                            this.doc35 = true;
                            this.doc35name = this.coApp4Array[j];
                        }
                    }
                }else
