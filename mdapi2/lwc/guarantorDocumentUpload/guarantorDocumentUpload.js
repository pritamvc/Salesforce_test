...
import fetchDocuments from '@salesforce/apex/DocumentController.fetchDocumentChecklist3';
        ...
        saveRecord() {
            ...
            saveGuest({newRecord: guestObj})
                .then(result => {
                    ...
                    this.saveMessage = 'Record saved successfully.';
                })
                .catch(error => {
                    this.error = error;
                    this.saveMessage = 'Error occurred while saving the record.';
                });
