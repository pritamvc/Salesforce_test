...
import getCoAppRecords from '@salesforce/apex/LeadCoapplicantEmploymentControllerClone.getCoapp';
import saveCoApplicant from '@salesforce/apex/LeadCoapplicantEmploymentControllerClone.saveCoApplicant';
import deleteCoApplicant from '@salesforce/apex/LeadCoapplicantEmploymentControllerClone.deleteCoApplicant';
import getApplicantAccoutId from '@salesforce/apex/LeadCoapplicantEmploymentControllerClone.getAccountIdFromCoApplicant';
...
import duplicateAccount from '@salesforce/apex/LeadCoapplicantEmploymentControllerClone.duplicateAccount';
import getSectionWeightage from '@salesforce/apex/LoanApplicationFormHelper.getSectionWeightage';
import getCheck  from '@salesforce/apex/LeadCoapplicantEmploymentControllerClone.getCheck';
import updateCheck  from '@salesforce/apex/LeadCoapplicantEmploymentControllerClone.updateCheck';
...
import KarzaKycOcr from '@salesforce/apex/KarzaKycOcrControllerClone.getDocumentOcred';
import checkPinCodeAvailable from '@salesforce/apex/LeadCoapplicantEmploymentControllerClone.checkPinCodeAvailable';
...
export default class CoapplicantGuarantorChild extends LightningElement {
        ...
        if (error) {
            ...
            if (data.fields.Profile.value != null) {
                ...
                if (this.userProfileName == 'Sales Profile') {
                    //this.isSalesUser = true; Uncomment after OCR 
   ...
   //Initializing the data
    ...
    //Method to call createRowaddNewRow
    addNewRow() {
       ...
       // var coApplicantSection = true;
        ...
        if (this.listOfAccounts.length > 0) {
            ...
            if (salesrAadharInvalid) {
                ...
                this.showToast("Error!!", 'Required either Father or Mother as financial co-applicant', "Error")
            }
            else if (appSameMobile) {
                this.showToast("Error!!", "Applicant and Financial Co-Applicant cannot have the same Mobile Number", "Error")       
            }
                ...
                saveCoApplicant({ coApplicantData: this.listOfAccounts, leadId: this.leadRecordId })
                    .then(result => { 
                        ...
                        //Progress bar update
                        let sum;
                        console.log('check:'+this.coapplicantCheck);
    ...
    setCoApplicantRecord(listOfAccounts) {
        ...
        listOfAccounts.forEach(function (account) {
            ...
            try {
                ...
                if(account.objeAcc.Date_of_Birth__c != undefined){
                    account.objeAcc['makedobdisable'] = true;
                }else{
                    account.objeAcc['makedobdisable'] = false;
                }
    ...
    uploadAadhar(event) {
        ...
        if (fileSize > 2.5) {
            ...
            //const fileName = 'Aadhar Document'+".";
    ...
    uploadPassport(event) {
        ...
        if (fileSize > 2.5) {
            ...
            //const fileName = 'Passport Document'+".";
            ...
            KarzaKycOcr({
                ...
                .then(async (result) => {
                    ...
                    if (responseObj.apistatusCode == 101) {
                        ...
                        console.log('kycAlreadyPresen=>',responseObj.kycAlreadyPresen);
                        ...
                        if(responseObj.kycNameMatch == false){
                            ...
                            console.log('aadharLastFour=>' , this.aadharLastFour);
