...
import getFinancialCoApplicants from '@salesforce/apex/QACommunityLeadFormController.getFinancialCoApplicants';
...
export default class CommunityFormARS extends LightningElement {
    ...
    getAllApplicantData() {
        getapplicantData({ leadGetId: this.leadRecordId })
            .then(result => {
                ...
                console.log(' getapplicantData this.getCountryOfStudyLead:', this.getCountryOfStudyLead);
                ...
                if (this.LAadharNumber != '' && this.LAadharNumber != undefined && this.leadSalutation != '' && this.leadSalutation != undefined &&
    ...
    newChangeAadhar(event) {
        ...
        console.log('errorAadharInvalid' + this.errorAadharInvalid);
        this.aadharLastFour = this.LAadharNumber.slice(-4);
    ...
    handlechange(event) {
        ...
        if (event.target.name == "appliCurrentyear") {
            ...
            console.log("this.AppliCurrentYear====  " + this.AppliCurrentYear);
        }
        ...
        if (event.target.name == "NREGNumber") {
            ...
            console.log("this.NREGNumber  " + this.NREGNumber);
        }
    ...
    @track financialCoApplicant;
    @track financialCoApplicantMobile = [];
    @track financialCoApplicantEmail = [];

    @track coAppMobileError = false;
    @track coAppEmailError = false;
    ...
    @track coAppNoEmail = false;
    @track coAppNoMobile = false;


    handleNextApplicant() {
        var appSameMobile;
        var appSameEmail;
        var passportErrorApplicant;
        if (this.financialCoApplicantMobile.includes(this.leadMobile)) {
            appSameMobile = true;
        }
        if (this.financialCoApplicantEmail.includes(this.leadEmail)) {
        ...
        console.log('this.passportNumber NEXT3:', this.passportNumber);
        console.log('this.getCountryOfStudyLead NEXT3:', this.getCountryOfStudyLead);
       
        if (this.passportNumber == undefined && this.getCountryOfStudyLead != undefined && this.getCountryOfStudyLead != 'INDIA') {
            console.log('Inside ifffffff2');
            this.dispatchEvent(
                new ShowToastEvent({
                    title: 'Error!!',
                    message: 'Please fill the Passport Number',
                    variant: 'Error',
                }),
            );
        }
            ...
            console.log('AADHAR NO', this.aadharLastFour);
            ...
            creatCommFormLeadRecords({
                ...
                .then(response => {
                    ...
                    console.log('###Publishmsg applicant section is' + applicantSection);
                    /************/
    ...
    checkduplicate(event) {
        if (event.target.value == '' || event.target.value == undefined) {
            ...
            console.log("true calculatePercent", this.calculatePercent + this.increasePercent);
        }
                ...
                if (result != null) {
                    if ((this.AppliAccID != this.duplicateAccountResult.objeAcc.Id) && (this.AppliAccID == null || this.AppliAccID == undefined) &&
                        ...
                        if (this.duplicateAccountResult.objeAcc.PAN_Number__c != null) {
                            console.log('INSIDE PAN NUMBER CONDITION');
