...
import createUpdateLeadWithRelatedInformation from '@salesforce/apex/LeadDealCourseAndAcademics.createUpdateLeadWithRelatedInformation';
import getInstituteRecord from '@salesforce/apex/LeadDealCourseAndAcademics.getInstituteRecord';
import getCourseEducationaData from '@salesforce/apex/LeadDealCourseAndAcademics.getWrapperClassCommFormList';
import getCourseIdName from '@salesforce/apex/LeadDealCourseAndAcademics.getCourseIdName';
import fetchLanguageCategory from '@salesforce/apex/LeadDealCourseAndAcademics.fetchLanguageCategory';
import fetchAnalyticalCategory from '@salesforce/apex/LeadDealCourseAndAcademics.fetchAnalyticalCategory';
import fetchAnalyticalCategoryGRE from '@salesforce/apex/LeadDealCourseAndAcademics.fetchAnalyticalCategoryGRE';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { getPicklistValues, getObjectInfo } from 'lightning/uiObjectInfoApi';
import getUniversityName from '@salesforce/apex/LeadDealCourseAndAcademics.getUniversityName';
import getLookupData from '@salesforce/apex/LeadDealCourseAndAcademics.getLookupData';
...
import HIGH_QUALIFICATION from '@salesforce/schema/Opportunity.Highest_Education_Qualification__c';

export default class LeadDealCourseAndAcademics extends LightningElement {
    @api getCourseData;
    @api leadRecordId;
    @wire(MessageContext)
    messageContext;
    ...
    getCourseEducationaFunction() {
        ...
        getCourseEducationaData({ leadGetId: this.leadRecordId })
            .then(result => {
                ...
                this.InstituteId = this.wrapperLoanApplicationFormResult.leadRecords.Institute__c;
                this.universityName = this.wrapperLoanApplicationFormResult.leadRecords.University__c;
                ...
                this.Intake = this.wrapperLoanApplicationFormResult.leadRecords.Intake_New__c;
