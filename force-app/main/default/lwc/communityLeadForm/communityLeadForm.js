...
export default class CommunityFormARS extends LightningElement {
   ...
   //Applicant section lead
    ...
    apiAdmissionStatus;
     ...
     @api EducationDetailsField = 'Education_Details__c';
 ...
 this.showModalMobile = false;
   ...
   console.log(data);
                   ...
                   this.salutationLabel = data.fields[this.salutationField].label;
                    ...
                    this.appliAddressTypeLabel = data.fields[this.appliAddressTypeField].label;
                     ...
                     this.appliAddressProofLabel = data.fields[this.appliAddressProofField].label;
                      ...
                      //Education Details
                      this.apiEducationDetails = this.objectName + '.' + this.EducationDetailsField;
    ...
    getPicklistValues13({ error, data }) {
     ...
     //Education Details
     @wire(getPicklistValues, { recordTypeId: '$recordTypeId', fieldApiName: '$apiEducationDetails' })
     getPicklistValues15({ error, data }) {
         if (data) {
             // Map picklist values
    ...
    setTimeout(() => {
       ...
       console.log("requestIdAadhar",this.requestIdAadhar);
        downloadAadhar({ 'otp': this.otpValueAadhar,'aadhaarNo':this.LAadharNumber, 'requestId':this.requestIdAadhar,'consent':'y'})
            .then((result) => {
                let responseObj1 = JSON.parse(result);
                let responseObj = responseObj1.dataResponse
 ...
 GetOtpAadhar(){
    ...
    if(this.LAadharNumber!=""&&this.LAadharNumber!=undefined){
        ...
        .then((result) => {
            ...
            this.requestIdAadhar = responseObj.dataResponse.requestId;
            if (responseObj.dataResponse.statusCode==101) {
 ...
 handleVerifyMob(){
    ...
    removeTheRow(event) {
        ...
        for (let i = 0; i < this.listOfAccounts.length; i++) {
          sum += this.listOfAccounts[i].index;
        }
...
console.log("Not Posssible")
    ...
    handlechange(event) {
        ...
        for(let i = 0; i < this.listOfAccounts.length; i++) {
            if(this.listOfAccounts[i].index === parseInt(index)) {
                ...
                console.log("event.target.value====  " + this.listOfAccounts[i][fieldName]);        
            }
        }
        // for(let i = 0; i < this.listOfEducationalTable.length; i++) {
    ...
    handleAppliPermanentAddBox(event){
       ...
       console.log("Chhecked: " + event.target.checked);
        if(this.AppliPermanentSameAsCurrent == true){
            ...
            console.log("this.AppliPermanentSameAsCurrent====  " + this.AppliPermanentSameAsCurrent);
            console.log("this.AppliPermanentAddProof====  " + this.AppliPermanentAddProof);
            console.log("this.AppliPermanentAddress====  " + this.AppliPermanentAddress);
            console.log("this.AppliPermanentCity====  " + this.AppliPermanentCity);
            console.log("this.AppliPermanentTaluka====  " + this.AppliPermanentTaluka);
    ...
    handleAppliEduDetails(event) {
        ...
        console.log('this.listOfEducationalTable[index][fieldName]' + JSON.stringify(this.listOfEducationalTable[index - 1]));
        this.listOfEducationalTable[index - 1][fieldName] = value;
        console.log('this.listOfEducationalTable[index][fieldName]' + this.listOfEducationalTable[index - 1][fieldName]);
    }
    ...
    handleSave() {
        ...
        if (this.LLastName != null && this.LLastName != null && this.LEmail != null && this.LMobile != null &&
            ...
            let wrapperAllRecord ={
                ...
                personAccStr: JSON.stringify(this.listOfAccounts),
            }
    ...
    wiredWrapperClassCommFormList({ error, data }) {
        ...
        if (data) {
            ...
            this.listOfEducationalTable = this.wrapperForCommLeadForm.AppliEduDetailsRecord;
