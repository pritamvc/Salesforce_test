...
import updateLeadLoanPercentage from '@salesforce/apex/ProgressBarPercent.updateLeadLoanPercentage';
import getLeadLoanPercentage from '@salesforce/apex/ProgressBarPercent.getLeadLoanPercentage';
        ...
        if (this.loanExpecTuitionFees == '' || this.loanExpecTuitionFees == undefined || this.loanExpecTuitionFees == 0) {
            ...
            creatCommFormLeadRecords1({
                ...
                .then(response => {
                    ...
                    debugger
                         getLeadLoanPercentage({leadId:this.leadRecordId})
                          .then(res => {
                         if(res>=3){
                            this.loanPercentageValue = 0;
                         }else{
                            this.loanPercentageValue = 3;
                         }
                        })
                         updateLeadLoanPercentage({ leadId: this.leadRecordId, percentage: this.loanPercentageValue })
                             .then(result => {
                                 if (result === 'Success') {
                                     console.log('Lead updated successfully');
                                     // Add any success logic here
                         ...
                         updateLeadTotalPercentage({ leadId: this.leadRecordId, percentage: this.loanPercentageValue })
                             .then(result => {
                                 if (result === 'Success') {
                                     console.log('Lead updated successfully');
                                     // Add any success logic here
                             ...
                             let ProgrssValueOfLoanSection = { ProgrssValueOfLoanSection: this.loanPercentageValue };
                             console.log('ProgressValueOfLoanSection +++', ProgrssValueOfLoanSection);
                             publish(this.messageContext, progressBar, ProgrssValueOfLoanSection);
                   ...
                   //debugger
                    ...
                    console.log('###Publishmsg is'+loanSection);
                    /************/
