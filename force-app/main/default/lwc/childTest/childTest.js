...
import DMSNames from '@salesforce/apex/LoanApplicationFormHelper.DMSNames';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';


export default class CommunityFormARSChild extends LightningElement {

        @wire(DMSNames) records;
    @track applicantLead;
        ...
        if (data) {
            ...
            try {
                ...
                for (var key in data) {
                    ...
                    options.push({ label: data[key].Name, value: data[key].Id, type: data[key].Type__c });
                    console.log('datatest3' + data[key].Name + data[key].Id);
    ...
    openFrontfileUpload(event,fileName) {
        ...
        reader.onload = () => {
            ...
            saveBase64File({ 
                leadId:'00QBi000003ngcHMAQ',
                accountId: '001Bi000005k1XlIAI',
                // accountId: this.AppliAccID,
                base64File: base64,
                fileName: fullName,
            })
            .then(result => {
