...
import creatLeadRecord from '@salesforce/apex/CommunityFormAvadhut.creatLeadRecord';
import creatCommFormLeadRecords from '@salesforce/apex/CommunityFormAvadhut.creatCommFormLeadRecord';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
import { getPicklistValues, getObjectInfo } from 'lightning/uiObjectInfoApi';
import getInstituteRecord from '@salesforce/apex/CommunityFormAvadhut.getInstituteRecord';
import getUniversityNameCourse from '@salesforce/apex/CommunityFormAvadhut.getUniversityNameCourse';
import getWrapperClassCommFormLists from '@salesforce/apex/CommunityFormAvadhut.getWrapperClassCommFormList';
import getPincodeRecord from '@salesforce/apex/CommunityFormAvadhut.getPincodeRecord';
 ...
 handleVerifyMob(){
   ...
   //Education Section
    ...
    handleApplicantCategory(event){
        if (event.target.name == "ApplicantCategoryCo" && event.target.value != "") {
            this.AppliCategoryvalue = event.target.value;
            console.log("this.AppliCategoryvalue====  " + this.AppliCategoryvalue);
        }    
        if (event.target.name == "ApplicantCategoryCo" && event.target.value !=="Guarantor") {
    ...
    handleRelationWithApplicant(event){
        if (event.target.name == "RelationshipwithAppli" && event.target.value != "") {
            this.RelshipWithAppliPerAcc = event.target.value;
            console.log("this.RelshipWithAppliPerAcc====  " + this.RelshipWithAppliPerAcc);
        }    
        if (event.target.name == "RelationshipwithAppli" && event.target.value ==="OTHER") {
